...
ensembles <- c("cAp211.085.48", "cAp211.085.56", "cB211.072.64", "cB211.072.96", "cC211.06.80", 
               "cD211.054.96_BC", "cD211.054.96_DE", "cE211ab.044.112", "cE211cd.044.112")
as <- c(0.087, 0.087, 0.080, 0.080, 0.068, 
...
label_dat <- data.frame(ens = c(ensembles[1:5], "cD211.054.96", "cE211.044.112"),
                        label = sprintf("$%s, a \\sim %.3f$ fm, $L/a = %d$",
                                        c(ensembles[1:5], "cD211.054.96", "cE211.044.112"),
                                        c(0.087, 0.087, 0.080, 0.080, 0.068, 0.057, 0.049),
                                        c(48, 56, 64, 96, 80, 96, 112)),
                        x = rep(740, times=7),
