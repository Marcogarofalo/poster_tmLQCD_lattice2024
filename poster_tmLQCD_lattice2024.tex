...
\begin{multicols}{2} % This is how many columns your poster will be broken into, a portrait poster is generally split into 2 columns
    ...
    \begin{center}
      \includegraphics[height=15cm]{ensembles_asquared_mpi}
    ...
    \begin{minipage}[t]{\linewidth}
      \begin{center}
        \includegraphics[height=14cm]{ensembles_phys_point}
        \hspace{2cm}
        \includegraphics[height=13cm]{amu_s_W_a4}
      \end{center}
    \end{minipage}
    ...
    \begin{minipage}{0.5\linewidth}
      ...
      %\begin{itemize}
      %  \item From left to right for each volume:
      %  \begin{itemize} 
      %    \item CPU run
      %    \item GPU run offloading only solves
      %    \item GPU run offloading solves and $N_f=2$ light quark force
      %    \item GPU run offloading solves and full $N_f=2+1+1$ quark force
      %  \end{itemize}
      %\item Up to factor 2.9 speedup in time per trajectory and much more in terms of energy cost per trajectory
      %\end{itemize}
    \end{minipage}
