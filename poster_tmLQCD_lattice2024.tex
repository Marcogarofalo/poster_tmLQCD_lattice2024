...
%    \end{abstract}
    ...
    \centering $\prod_{i=n_\ell}^{n_k} \frac{ \Qhat^2_h + a_{2i-1} }{ \Qhat^2_h + a_{2i} }$ & $1+1$ non-degenerate determinant $\rightarrow$ RHMC, single precision multi-shift CG with double-half precision shift-by-shift refinement
    \end{tabular}
